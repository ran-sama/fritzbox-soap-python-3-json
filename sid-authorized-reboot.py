...
def main():
    ...
    url = "http://10.0.0.1:49000/upnp/control/deviceconfig"
    headers = {'soapaction': 'urn:schemas-upnp-org:service:DeviceConfig:1#Reboot', 'Authorization': method_modern, 'content-type': 'text/xml','charset': 'utf-8'}
    body = """<?xml version='1.0' encoding='utf-8'?><s:Envelope s:encodingStyle='http://schemas.xmlsoap.org/soap/encoding/' xmlns:s='http://schemas.xmlsoap.org/soap/envelope/'><s:Body><u:Reboot xmlns:u='urn:schemas-upnp-org:service:DeviceConfig:1' /></s:Body></s:Envelope>"""
